...
async function createFullWordDoc() {
  // Use the complete resume content matching the database exactly
  ...
  fs.writeFileSync('client/public/Zana_Mathuthu_Full_Resume.docx', buffer);
  
  console.log('Full Word document created: Zana_Mathuthu_Full_Resume.docx');
  console.log('File size:', buffer.length, 'bytes');
}

createFullWordDoc().catch(console.error);